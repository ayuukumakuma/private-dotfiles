---
title: "Tips & Tricks | SketchyBar"
source_url: "https://felixkratz.github.io/SketchyBar/config/tricks"
...
## Batching of configuration commands[​](https://felixkratz.github.io/SketchyBar/config/tricks.html#batching-of-configuration-commands "Direct link to heading")
...
### Using bash arrays for cleaner configuration[​](https://felixkratz.github.io/SketchyBar/config/tricks.html#using-bash-arrays-for-cleaner-configuration "Direct link to heading")
...
## Debugging Problems[​](https://felixkratz.github.io/SketchyBar/config/tricks.html#debugging-problems "Direct link to heading")
...
## Color Picker[​](https://felixkratz.github.io/SketchyBar/config/tricks.html#color-picker "Direct link to heading")
...
## Finding Icons[​](https://felixkratz.github.io/SketchyBar/config/tricks.html#finding-icons "Direct link to heading")
...
## Multiple Bars[​](https://felixkratz.github.io/SketchyBar/config/tricks.html#multiple-bars "Direct link to heading")
...
## Performance optimizations[​](https://felixkratz.github.io/SketchyBar/config/tricks.html#performance-optimizations "Direct link to heading")
...
* Set *updates=when\_shown* for items that do not need to run their script if they are not rendered.
* Reduce the *update\_freq* of *scripts* and *aliases* and use event-driven scripting when ever possible.
...
Reloading the configuration](https://felixkratz.github.io/SketchyBar/config/reloading.html)[Next

Credits](https://felixkratz.github.io/SketchyBar/credits.html)

* [Batching of configuration commands](https://felixkratz.github.io/SketchyBar/config/tricks.html#batching-of-configuration-commands)
  + [Using bash arrays for cleaner configuration](https://felixkratz.github.io/SketchyBar/config/tricks.html#using-bash-arrays-for-cleaner-configuration)
* [Debugging Problems](https://felixkratz.github.io/SketchyBar/config/tricks.html#debugging-problems)
* [Color Picker](https://felixkratz.github.io/SketchyBar/config/tricks.html#color-picker)
* [Finding Icons](https://felixkratz.github.io/SketchyBar/config/tricks.html#finding-icons)
* [Multiple Bars](https://felixkratz.github.io/SketchyBar/config/tricks.html#multiple-bars)
* [Performance optimizations](https://felixkratz.github.io/SketchyBar/config/tricks.html#performance-optimizations)
