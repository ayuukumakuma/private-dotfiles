---
title: "Item Properties | SketchyBar"
source_url: "https://felixkratz.github.io/SketchyBar/config/items"
...
## Items and their properties[​](https://felixkratz.github.io/SketchyBar/config/items.html#items-and-their-properties "Direct link to heading")
...
![Item Structure](https://felixkratz.github.io/SketchyBar/assets/images/bar_item-b6101bdffaa334e82f7d34f26c6d5bba.jpg)

### Adding items to SketchyBar[​](https://felixkratz.github.io/SketchyBar/config/items.html#adding-items-to-sketchybar "Direct link to heading")
...
### Changing item properties[​](https://felixkratz.github.io/SketchyBar/config/items.html#changing-item-properties "Direct link to heading")
...
### Geometry Properties[​](https://felixkratz.github.io/SketchyBar/config/items.html#geometry-properties "Direct link to heading")
...
### Icon properties[​](https://felixkratz.github.io/SketchyBar/config/items.html#icon-properties "Direct link to heading")
...
### Label properties[​](https://felixkratz.github.io/SketchyBar/config/items.html#label-properties "Direct link to heading")
...
### Scripting properties[​](https://felixkratz.github.io/SketchyBar/config/items.html#scripting-properties "Direct link to heading")
...
### Text properties[​](https://felixkratz.github.io/SketchyBar/config/items.html#text-properties "Direct link to heading")

| <text\_property> | <value> | default | description |
| --- | --- | --- | --- |
...
### Background properties[​](https://felixkratz.github.io/SketchyBar/config/items.html#background-properties "Direct link to heading")

| <background\_property> | <value> | default | description |
| --- | --- | --- | --- |
...
### Image properties[​](https://felixkratz.github.io/SketchyBar/config/items.html#image-properties "Direct link to heading")

| <image\_property> | <value> | default | description |
| --- | --- | --- | --- |
...
### Shadow properties[​](https://felixkratz.github.io/SketchyBar/config/items.html#shadow-properties "Direct link to heading")

| <shadow\_property> | <value> | default | description |
| --- | --- | --- | --- |
...
### Changing the default values for all further items[​](https://felixkratz.github.io/SketchyBar/config/items.html#changing-the-default-values-for-all-further-items "Direct link to heading")
...
### Item Reordering[​](https://felixkratz.github.io/SketchyBar/config/items.html#item-reordering "Direct link to heading")
...
### Moving Items to specific positions[​](https://felixkratz.github.io/SketchyBar/config/items.html#moving-items-to-specific-positions "Direct link to heading")
...
### Item Cloning[​](https://felixkratz.github.io/SketchyBar/config/items.html#item-cloning "Direct link to heading")
...
### Renaming Items[​](https://felixkratz.github.io/SketchyBar/config/items.html#renaming-items "Direct link to heading")
...
### Removing Items[​](https://felixkratz.github.io/SketchyBar/config/items.html#removing-items "Direct link to heading")
...
Bar Properties](https://felixkratz.github.io/SketchyBar/config/bar.html)[Next

Special Components](https://felixkratz.github.io/SketchyBar/config/components.html)

* [Items and their properties](https://felixkratz.github.io/SketchyBar/config/items.html#items-and-their-properties)
  + [Adding items to SketchyBar](https://felixkratz.github.io/SketchyBar/config/items.html#adding-items-to-sketchybar)
  + [Changing item properties](https://felixkratz.github.io/SketchyBar/config/items.html#changing-item-properties)
  + [Geometry Properties](https://felixkratz.github.io/SketchyBar/config/items.html#geometry-properties)
  + [Icon properties](https://felixkratz.github.io/SketchyBar/config/items.html#icon-properties)
  + [Label properties](https://felixkratz.github.io/SketchyBar/config/items.html#label-properties)
  + [Scripting properties](https://felixkratz.github.io/SketchyBar/config/items.html#scripting-properties)
  + [Text properties](https://felixkratz.github.io/SketchyBar/config/items.html#text-properties)
  + [Background properties](https://felixkratz.github.io/SketchyBar/config/items.html#background-properties)
  + [Image properties](https://felixkratz.github.io/SketchyBar/config/items.html#image-properties)
  + [Shadow properties](https://felixkratz.github.io/SketchyBar/config/items.html#shadow-properties)
  + [Changing the default values for all further items](https://felixkratz.github.io/SketchyBar/config/items.html#changing-the-default-values-for-all-further-items)
  + [Item Reordering](https://felixkratz.github.io/SketchyBar/config/items.html#item-reordering)
  + [Moving Items to specific positions](https://felixkratz.github.io/SketchyBar/config/items.html#moving-items-to-specific-positions)
  + [Item Cloning](https://felixkratz.github.io/SketchyBar/config/items.html#item-cloning)
  + [Renaming Items](https://felixkratz.github.io/SketchyBar/config/items.html#renaming-items)
  + [Removing Items](https://felixkratz.github.io/SketchyBar/config/items.html#removing-items)
