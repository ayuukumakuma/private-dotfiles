...
source_url: "https://felixkratz.github.io/SketchyBar/config/events"
...
## Events and Scripting[​](https://felixkratz.github.io/SketchyBar/config/events.html#events-and-scripting "Direct link to heading")
...
### Creating custom events[​](https://felixkratz.github.io/SketchyBar/config/events.html#creating-custom-events "Direct link to heading")
...
### Triggering custom events[​](https://felixkratz.github.io/SketchyBar/config/events.html#triggering-custom-events "Direct link to heading")
...
### Forcing all shell scripts to run and the bar to refresh[​](https://felixkratz.github.io/SketchyBar/config/events.html#forcing-all-shell-scripts-to-run-and-the-bar-to-refresh "Direct link to heading")
...
Popup Menus](https://felixkratz.github.io/SketchyBar/config/popups.html)[Next

Querying Information](https://felixkratz.github.io/SketchyBar/config/querying.html)

* [Events and Scripting](https://felixkratz.github.io/SketchyBar/config/events.html#events-and-scripting)
  + [Creating custom events](https://felixkratz.github.io/SketchyBar/config/events.html#creating-custom-events)
  + [Triggering custom events](https://felixkratz.github.io/SketchyBar/config/events.html#triggering-custom-events)
  + [Forcing all shell scripts to run and the bar to refresh](https://felixkratz.github.io/SketchyBar/config/events.html#forcing-all-shell-scripts-to-run-and-the-bar-to-refresh)
