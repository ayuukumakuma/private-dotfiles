...
source_url: "https://felixkratz.github.io/SketchyBar/config/bar"
...
## Configuration of the bar[​](https://felixkratz.github.io/SketchyBar/config/bar.html#configuration-of-the-bar "Direct link to heading")
...
You can find the nomenclature for all the types [here](https://felixkratz.github.io/SketchyBar/config/types.html).
If you are looking for colors, check out the [color picker](https://felixkratz.github.io/SketchyBar/config/tricks.html#color-picker).

[Previous

Setup](https://felixkratz.github.io/SketchyBar/setup.html)[Next

Item Properties](https://felixkratz.github.io/SketchyBar/config/items.html)

* [Configuration of the bar](https://felixkratz.github.io/SketchyBar/config/bar.html#configuration-of-the-bar)
