...
Close the current tab and all splits therein *or* close all tabs and
splits thein of tabs *other* than the current tab, depending on the
mode.
...
* [quit](https://ghostty.org/docs/config/keybind/reference.html#quit)
* [crash](https://ghostty.org/docs/config/keybind/reference.html#crash)
